    ...
    },
    {
      ...
      objects = {
        ...
        },
        {
          ...
          visible = true,
          properties = {
            ["text1"] = "* Lights flicker among the walls\nof the casino you find yourself\nwithin.",
            ["text2"] = "* The power of raising the game's\nage rating shines within you."
          }
        },
        {
          id = 28,
