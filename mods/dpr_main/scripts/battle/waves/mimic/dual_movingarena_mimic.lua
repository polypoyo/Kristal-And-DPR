local Dual_MovingArena_Mimic, super = Class(Wave)

function Dual_MovingArena_Mimic:init()
    super.init(self)
...
function Dual_MovingArena_Mimic:spawnstarthing()
...
function Dual_MovingArena_Mimic:update()
    ...
    -- Move the arena
    Game.battle.arena:setPosition(self.arena_start_x + coal * 2, self.arena_start_y + offset + ball)
